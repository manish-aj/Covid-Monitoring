...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table "+  TABLE_NAME+
                "(timestamp BIGINT PRIMARY KEY, heart_rate INTEGER, respiratory_rate INTEGER, latitude BIGINT, longitude BIGINT,  nausea INTEGER," +
    ...
    public boolean insertOrUpdateData(long timestamp, int heartRate, int respiratoryRate, long latitude, long longitude, HashMap<String, Integer> symptoms){
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("timestamp", timestamp);
